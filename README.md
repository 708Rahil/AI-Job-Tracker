...
![AI Job Tracker Screenshot](./assets/demo.png)  
*Add jobs, view AI summaries, and track status.*

---

## ⚡ Features

- Add jobs with **title, company, and description**  
- **AI-generated summaries** with Transformers  
- Track status: Applied, Interviewing, Rejected, Offer  
- Save jobs in **PostgreSQL**  
- Filter jobs by status (coming soon)  
...
- **Database:** PostgreSQL  
- **Dev Tools:** CORS, Docker (optional)  
